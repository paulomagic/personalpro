        ...
        <div className="max-w-md mx-auto min-h-screen bg-slate-950 text-white selection:bg-blue-500/30 pb-12">
            ...
            <div className="px-6 grid grid-cols-3 gap-3 mb-8 animate-slide-up">
                ...
                <div className="glass-card rounded-[24px] p-4 text-center border-b-2 border-amber-500">
                    <p className="text-xl font-black text-amber-400">{stats.atRisk}</p>
            ...
            <div className="px-6 space-y-4 animate-slide-up stagger-2">
                {loading ? (
                        ...
                        >
                            <div className="relative">
                                {client.avatar ? (
                                    ...
                                    <div className="size-16 rounded-[24px] bg-slate-800 flex items-center justify-center border-2 border-white/5">
                                ...
                                <span className={`absolute -bottom-1 -right-1 size-5 rounded-full border-4 border-slate-950 ${client.status === 'active' ? 'bg-emerald-500 shadow-[0_0_10px_rgba(16,185,129,0.5)]' :
                                        client.status === 'at-risk' ? 'bg-amber-500 shadow-[0_0_10px_rgba(245,158,11,0.5)]' :
                                            client.status === 'paused' ? 'bg-slate-500' : 'bg-slate-300'
                                    }`}></span>
                            </div>
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-[9px] text-slate-500 font-bold uppercase tracking-widest mt-2">
                                    {client.lastTraining || 'Sem treino registrado'}
                                </p>
                            </div>
                    ...
                    <div className="py-12 text-center text-slate-600">
                        ...
                        <p className="text-xs">Comece adicionando seu primeiro protocolo de elite.</p>
                    </div>
                )}
            </div>
        </div>
