...
export const mockExercises: WorkoutExercise[] = [
    ...
    // ============ SUPERIOR: PEITO ============
    { id: 'ch1', name: 'Supino Reto Barra', category: 'musculacao', sets: [{ method: 'simples', reps: '10', load: '60kg', rest: '90s' }], targetMuscle: 'Peito', videoUrl: 'https://www.youtube.com/watch?v=rT7DgCr-3pg' },
    ...
    // ============ SUPERIOR: BÍCEPS ============
    { id: 'bi1', name: 'Rosca Direta Barra W', category: 'musculacao', sets: [{ method: 'simples', reps: '12', load: '20kg', rest: '60s' }], targetMuscle: 'Bíceps', videoUrl: 'https://www.youtube.com/watch?v=kwG2ipFRgfo' },
