...
export const mockExercises: WorkoutExercise[] = [
    ...
    // ============ SUPERIOR: PEITO ============
    { id: 'ch1', name: 'Supino Reto Barra', category: 'musculacao', sets: [{ method: 'simples', reps: '10', load: '60kg', rest: '90s' }], targetMuscle: 'Peito', videoUrl: 'https://www.youtube.com/watch?v=4Y2ZdHCOXok' },
    ...
    // ============ INFERIOR: QUADRÍCEPS ============
    { id: 'quad1', name: 'Agachamento Livre', category: 'musculacao', sets: [{ method: 'simples', reps: '10', load: '80kg', rest: '120s' }], targetMuscle: 'Quadríceps', videoUrl: 'https://www.youtube.com/watch?v=gcNh17Ckjgg' },
